...
## Project Structure
    ...
    ├── tst_keystore_issue_3  # Django project configurations
...
1. Clone this repo and `cd tst_keystore_issue_3`
...
2. Clone this repo and `cd tst_keystore_issue_3`
